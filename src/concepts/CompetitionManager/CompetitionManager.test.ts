...
Deno.test("Operational Principle: Full competition lifecycle and leaderboard", async () => {
  ...
  try{
    ...
    const midLeaderboard = midLeaderboardResult as string;
    console.log(`Result: ${midLeaderboard}`);
    ...
    assertEquals(midLeaderboard, JSON.stringify(expectedMidLeaderboard), "Mid-competition leaderboard should match expected ranking.");
    ...
    const postLeaderboard = postLeaderboardResult as string;
    console.log(`Result: ${JSON.stringify(postLeaderboard)}`);
    // Leaderboard should remain the same, as scores don't change after ending.
    assertEquals(postLeaderboard, JSON.stringify(expectedMidLeaderboard), "Post-competition leaderboard should match expected ranking.");
