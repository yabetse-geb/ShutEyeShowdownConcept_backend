---
timestamp: 'Wed Oct 15 2025 01:19:39 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251015_011939.d1ec1c17.md]]'
content_id: 6d55206c1a97bc8b4760db4016654b3561551c4389d8af1dae9ea1d6dd4ea9a9
---
...
export default class CompetitionManagerConcept {
  ...
  async removeParticipant(
    ...
    // Requires: c.participants.size() > 2 (ensuring at least two participants remain)
    if (competition.participants.length <= 2) {
      return { error: `Cannot remove participant. Competition ${competitionId} requires at least two participants.` };
    }
    ...
    // Effects: Removes the CompetitionScore cs for userId and competitionId
