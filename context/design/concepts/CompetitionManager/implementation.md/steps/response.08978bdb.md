---
timestamp: 'Wed Oct 15 2025 02:20:51 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251015_022051.9d3d7837.md]]'
content_id: 08978bdba3dc5cd3b0813d546fb3e630fbd9ee975d249cfc2c8620dc12af92bb
---
...
export default class CompetitionManagerConcept {
  ...
  async recordStat(
    ...
    const updatePromises = relevantCompetitions.map(async (comp) => {
      // Check if DailyEvent already exists (for idempotency)
