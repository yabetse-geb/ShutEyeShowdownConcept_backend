---
timestamp: 'Tue Oct 21 2025 16:16:11 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251021_161611.e563637d.md]]'
content_id: 39aee3ac78010aa97c59610815eef03a333cb0c66f8a97f8f19cf6c3bbe77071
---
...
export default class CompetitionManagerConcept {
  ...
  /**
   * @query _getCompetitionsForUser(u: User): Competition[]
   * @purpose To retrieve all competitions a specific user is participating in.
   * @requires:
   *   - `u` must be a valid User ID.
   * @effects:
   *   - Returns an array of all Competition objects where `u` is a member of the `participants` array.
   *   - Returns an empty array if the user is not in any competitions.
   */
