---
timestamp: 'Wed Oct 15 2025 01:14:57 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251015_011457.62688721.md]]'
content_id: 06db557766fd7009a382611fc528c46115afac9c12714aa3655b05f3e35b8af9
---
  ...
  * `removeParticipant (competitionId: CompetitionId, userId: UserId)`
    ...
    * **effects**:
      ...
      * If `c.participants.size() < 2`:
        * Sets `c.active` to `false`.
        * Sets `c.winners` to `null` (as the competition is no longer viable and cannot have winners).
