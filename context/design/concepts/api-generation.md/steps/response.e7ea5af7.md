...
    // Effects: Sets bedTimeSuccess based on tolerance

    const differenceInMins = Math.abs(reportedTime.getTime() - sleepSlot.bedTime.getTime());

    const bedTimeSuccess = differenceInMins <= sleepSlot.toleranceMins * 60 * 1000;
...
    // Effects: Sets wakeUpSuccess based on tolerance
...
    const wakeUpSuccess = differenceInMins <= sleepSlot.toleranceMins * 60 * 1000;
